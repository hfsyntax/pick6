...
export async function handlePicks(prevState: any, formData: FormData): Promise<FormResult> {
    try {
...
export async function changePassword(prevState: any, formData: FormData): Promise<FormResult> {
    try {
